...
#SBATCH --requeue
#SBATCH --output=/n/netscratch/yelin_lab/Everyone/andigu/scaling/d19-curriculum/slurm_%j.out
#SBATCH --error=/n/netscratch/yelin_lab/Everyone/andigu/scaling/d19-curriculum/slurm_%j.err
...
mkdir -p /n/netscratch/yelin_lab/Everyone/andigu/scaling/d19-curriculum
