...
#SBATCH --requeue
#SBATCH --output=/n/netscratch/yelin_lab/Everyone/andigu/scaling/d15-curriculum/slurm_%j.out
#SBATCH --error=/n/netscratch/yelin_lab/Everyone/andigu/scaling/d15-curriculum/slurm_%j.err
...
echo "Experiment: d15-curriculum"
...
mkdir -p /n/netscratch/yelin_lab/Everyone/andigu/scaling/d15-curriculum
...
python src/train.py \
    ...
    experiment.name=d15-curriculum \
    wandb.enabled=true \
