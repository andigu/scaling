...
#SBATCH --requeue
#SBATCH --output=/n/netscratch/yelin_lab/Everyone/andigu/scaling/d13-adamw/slurm_%j.out
#SBATCH --error=/n/netscratch/yelin_lab/Everyone/andigu/scaling/d13-adamw/slurm_%j.err

set -e

echo "=== Starting Training: d13 with AdamW Optimizer ==="
echo "Time: $(date)"
echo "Node: $SLURM_NODELIST"
echo "Job ID: $SLURM_JOB_ID"
echo "Experiment: d13-adamw"
echo "Purpose: Training d13 surface code with AdamW optimizer"
echo "Distance: 13"
echo "GPU: 1x H100"
...
mkdir -p /n/netscratch/yelin_lab/Everyone/andigu/scaling/d13-adamw
...
echo "=== Running Training with AdamW Optimizer ==="
echo "Configuration:"
echo "- Model: ResNet50"
...
echo "4. Compare with ScheduleFree results"
echo ""